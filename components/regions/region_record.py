...
class RegionRecord:
    ...
    def init_from_pd_series(self, pd_series):
        self.region_id: int = pd_series.loc['RegionID'].loc[0]
        self.size_rank: int = pd_series.loc['SizeRank'].loc[0]
        self.region_name: str = pd_series.loc['RegionName'].loc[0]
        self.region_type: str = pd_series.loc['RegionType'].loc[0]
        self.state_name: str = pd_series.loc['StateName'].loc[0]
